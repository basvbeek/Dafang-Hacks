...
enum opt_code
{
  ...
  OPT_mabs_ = 1960,                          /* -mabs= */
  OPT_mandroid = 1961,                       /* -mandroid */
  OPT_march_ = 1962,                         /* -march= */
  OPT_mbionic = 1963,                        /* -mbionic */
  OPT_mbranch_cost_ = 1964,                  /* -mbranch-cost= */
  OPT_mbranch_likely = 1965,                 /* -mbranch-likely */
  OPT_mcheck_zero_division = 1966,           /* -mcheck-zero-division */
  OPT_mcode_readable_ = 1967,                /* -mcode-readable= */
  OPT_mcompact_branches_ = 1968,             /* -mcompact-branches= */
  OPT_mcrc = 1969,                           /* -mcrc */
  OPT_mdebug = 1970,                         /* -mdebug */
  OPT_mdebugd = 1971,                        /* -mdebugd */
  OPT_mdivide_breaks = 1972,                 /* -mdivide-breaks */
  OPT_mdivide_traps = 1973,                  /* -mdivide-traps */
  OPT_mdmx = 1974,                           /* -mdmx */
  OPT_mdouble_float = 1975,                  /* -mdouble-float */
  OPT_mdsp = 1976,                           /* -mdsp */
  OPT_mdspr2 = 1977,                         /* -mdspr2 */
  OPT_meb = 1978,                            /* -meb */
  OPT_mel = 1979,                            /* -mel */
  OPT_membedded_data = 1980,                 /* -membedded-data */
  OPT_meva = 1981,                           /* -meva */
  /* OPT_mexplicit_relocs = 1982, */         /* -mexplicit-relocs */
  OPT_mexplicit_relocs_ = 1983,              /* -mexplicit-relocs= */
  OPT_mextern_sdata = 1984,                  /* -mextern-sdata */
  OPT_mfix_24k = 1985,                       /* -mfix-24k */
  OPT_mfix_r10000 = 1986,                    /* -mfix-r10000 */
  OPT_mfix_r4000 = 1987,                     /* -mfix-r4000 */
  OPT_mfix_r4400 = 1988,                     /* -mfix-r4400 */
  OPT_mfix_r5900 = 1989,                     /* -mfix-r5900 */
  OPT_mfix_rm7000 = 1990,                    /* -mfix-rm7000 */
  OPT_mfix_sb1 = 1991,                       /* -mfix-sb1 */
  OPT_mfix_vr4120 = 1992,                    /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 1993,                    /* -mfix-vr4130 */
  OPT_mfix4300 = 1994,                       /* -mfix4300 */
  OPT_mflip_mips16 = 1995,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 1996,                   /* -mflush-func= */
  OPT_mfp_exceptions = 1997,                 /* -mfp-exceptions */
  OPT_mfp32 = 1998,                          /* -mfp32 */
  OPT_mfp64 = 1999,                          /* -mfp64 */
  OPT_mfpxx = 2000,                          /* -mfpxx */
  OPT_mframe_header_opt = 2001,              /* -mframe-header-opt */
  /* OPT_mfused_madd = 2002, */              /* -mfused-madd */
  OPT_mginv = 2003,                          /* -mginv */
  OPT_mglibc = 2004,                         /* -mglibc */
  OPT_mgp32 = 2005,                          /* -mgp32 */
  OPT_mgp64 = 2006,                          /* -mgp64 */
  OPT_mgpopt = 2007,                         /* -mgpopt */
  OPT_mhard_float = 2008,                    /* -mhard-float */
  OPT_mimadd = 2009,                         /* -mimadd */
  OPT_minterlink_compressed = 2010,          /* -minterlink-compressed */
  OPT_minterlink_mips16 = 2011,              /* -minterlink-mips16 */
  OPT_mips = 2012,                           /* -mips */
  OPT_mips16 = 2013,                         /* -mips16 */
  OPT_mips3d = 2014,                         /* -mips3d */
  OPT_mllsc = 2015,                          /* -mllsc */
  OPT_mload_store_pairs = 2016,              /* -mload-store-pairs */
  OPT_mlocal_sdata = 2017,                   /* -mlocal-sdata */
  OPT_mlong_calls = 2018,                    /* -mlong-calls */
  OPT_mlong32 = 2019,                        /* -mlong32 */
  OPT_mlong64 = 2020,                        /* -mlong64 */
  OPT_mloongson_ext = 2021,                  /* -mloongson-ext */
  OPT_mloongson_ext2 = 2022,                 /* -mloongson-ext2 */
  OPT_mloongson_mmi = 2023,                  /* -mloongson-mmi */
  OPT_mlra = 2024,                           /* -mlra */
  OPT_mlxc1_sxc1 = 2025,                     /* -mlxc1-sxc1 */
  OPT_mmad = 2026,                           /* -mmad */
  OPT_mmadd4 = 2027,                         /* -mmadd4 */
  OPT_mmcount_ra_address = 2028,             /* -mmcount-ra-address */
  OPT_mmcu = 2029,                           /* -mmcu */
  OPT_mmemcpy = 2030,                        /* -mmemcpy */
  OPT_mmicromips = 2031,                     /* -mmicromips */
  OPT_mmips16e2 = 2032,                      /* -mmips16e2 */
  OPT_mmsa = 2033,                           /* -mmsa */
  OPT_mmt = 2034,                            /* -mmt */
  OPT_mmusl = 2035,                          /* -mmusl */
  OPT_mnan_ = 2036,                          /* -mnan= */
  /* OPT_mno_explicit_relocs = 2037, */      /* -mno-explicit-relocs */
  OPT_mno_float = 2038,                      /* -mno-float */
  OPT_mno_flush_func = 2039,                 /* -mno-flush-func */
  OPT_mno_mdmx = 2040,                       /* -mno-mdmx */
  OPT_mno_mips16 = 2041,                     /* -mno-mips16 */
  OPT_mno_mips3d = 2042,                     /* -mno-mips3d */
  /* OPT_mno_unaligned_access = 2043, */     /* -mno-unaligned-access */
  OPT_modd_spreg = 2044,                     /* -modd-spreg */
  OPT_mpaired_single = 2045,                 /* -mpaired-single */
  OPT_mplt = 2046,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 2047,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 2048,               /* -mrelax-pic-calls */
  OPT_mshared = 2049,                        /* -mshared */
  OPT_msingle_float = 2050,                  /* -msingle-float */
  OPT_msmartmips = 2051,                     /* -msmartmips */
  OPT_msoft_float = 2052,                    /* -msoft-float */
  OPT_msplit_addresses = 2053,               /* -msplit-addresses */
  OPT_mstrict_align = 2054,                  /* -mstrict-align */
  OPT_msym32 = 2055,                         /* -msym32 */
  OPT_msynci = 2056,                         /* -msynci */
  OPT_mtune_ = 2057,                         /* -mtune= */
  OPT_muclibc = 2058,                        /* -muclibc */
  /* OPT_munaligned_access = 2059, */        /* -munaligned-access */
  OPT_muninit_const_in_rodata = 2060,        /* -muninit-const-in-rodata */
  OPT_mvirt = 2061,                          /* -mvirt */
  OPT_mvr4130_align = 2062,                  /* -mvr4130-align */
  OPT_mxgot = 2063,                          /* -mxgot */
  OPT_mxpa = 2064,                           /* -mxpa */
  OPT_n = 2065,                              /* -n */
  OPT_name_sort = 2066,                      /* -name-sort */
  OPT_no_canonical_prefixes = 2067,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 2068,              /* -no-integrated-cpp */
  OPT_no_pie = 2069,                         /* -no-pie */
  OPT_noasmopt = 2070,                       /* -noasmopt */
  ...
  /* OPT_std_c89 = 2154, */                  /* -std=c89 */
  OPT_std_c90 = 2155,                        /* -std=c90 */
  OPT_std_c99 = 2156,                        /* -std=c99 */
  /* OPT_std_c9x = 2157, */                  /* -std=c9x */
  OPT_std_f2003 = 2158,                      /* -std=f2003 */
  OPT_std_f2008 = 2159,                      /* -std=f2008 */
  OPT_std_f2008ts = 2160,                    /* -std=f2008ts */
  OPT_std_f2018 = 2161,                      /* -std=f2018 */
  OPT_std_f2023 = 2162,                      /* -std=f2023 */
  OPT_std_f95 = 2163,                        /* -std=f95 */
  OPT_std_gnu = 2164,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2165, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2166, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2167,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2168,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2169,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2170, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2171, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2172,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2173,                    /* -std=gnu++23 */
  OPT_std_gnu__26 = 2174,                    /* -std=gnu++26 */
  /* OPT_std_gnu__2a = 2175, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2176, */              /* -std=gnu++2b */
  /* OPT_std_gnu__2c = 2177, */              /* -std=gnu++2c */
  OPT_std_gnu__98 = 2178,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 2179,                      /* -std=gnu11 */
  OPT_std_gnu17 = 2180,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 2181, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 2182, */                /* -std=gnu1x */
  OPT_std_gnu23 = 2183,                      /* -std=gnu23 */
  /* OPT_std_gnu2x = 2184, */                /* -std=gnu2x */
  /* OPT_std_gnu89 = 2185, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2186,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2187,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2188, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2189, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2190,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2191, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2192, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2193, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2194, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2195, */         /* -std=iso9899:2018 */
  /* OPT_std_iso9899_2024 = 2196, */         /* -std=iso9899:2024 */
  OPT_std_legacy = 2197,                     /* -std=legacy */
  OPT_stdlib_ = 2198,                        /* -stdlib= */
  OPT_symbol_ = 2199,                        /* -symbol= */
  OPT_symbolic = 2200,                       /* -symbolic */
  OPT_t = 2201,                              /* -t */
  OPT_time = 2202,                           /* -time */
  OPT_time_ = 2203,                          /* -time= */
  OPT_tno_android_cc = 2204,                 /* -tno-android-cc */
  OPT_tno_android_ld = 2205,                 /* -tno-android-ld */
  OPT_traditional = 2206,                    /* -traditional */
  OPT_traditional_cpp = 2207,                /* -traditional-cpp */
  OPT_tree_stats = 2208,                     /* -tree-stats */
  OPT_trigraphs = 2209,                      /* -trigraphs */
