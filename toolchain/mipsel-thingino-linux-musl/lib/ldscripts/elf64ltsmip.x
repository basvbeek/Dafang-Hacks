...
OUTPUT_ARCH(mips)
ENTRY(__start)
SEARCH_DIR("=/github/home/output/toolchain_xburst1_musl_gcc14/host/mipsel-thingino-linux-musl/lib64"); SEARCH_DIR("=/usr/local/lib64"); SEARCH_DIR("=/lib64"); SEARCH_DIR("=/usr/lib64"); SEARCH_DIR("=/github/home/output/toolchain_xburst1_musl_gcc14/host/mipsel-thingino-linux-musl/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
