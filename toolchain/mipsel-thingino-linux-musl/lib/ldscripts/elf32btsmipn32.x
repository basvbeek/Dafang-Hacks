...
OUTPUT_ARCH(mips)
ENTRY(__start)
SEARCH_DIR("=/github/home/output/toolchain_xburst1_musl_gcc14/host/mipsel-thingino-linux-musl/lib32"); SEARCH_DIR("=/usr/local/lib32"); SEARCH_DIR("=/lib32"); SEARCH_DIR("=/usr/lib32"); SEARCH_DIR("=/github/home/output/toolchain_xburst1_musl_gcc14/host/mipsel-thingino-linux-musl/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
